...
| 屏幕基础验证 | P0 | 已通过初步验证 | 全屏绿色测试画面。 | 上传 `screen_green_factory_test.jpg`。 |
| 触摸屏验证 | P0 | 已通过初步验证 | Touch down 坐标日志。 | 上传触摸日志截图和文本日志。 |
| 串口基础验证 | P0 | 已通过 | USB-SERIAL CH340 COM5，SSCOM 1000000，R:32236。 | 保存完整 SSCOM 串口日志。 |
| 按键状态机 | P0 | 待做 | 待补充人工结果。 | 依赖 KEY1 / KEY2 日志确认。 |
| 喇叭提示音 | P0 | 待测试 | 待补充人工结果。 | 测试喇叭或 SPK 接口。 |
| 麦克风输入 | P0 | 待测试 | 待补充人工结果。 | 测试麦克风输入或录音。 |
